...
-- TODO: let's use Network.Connection.ConnectionParams instead
...
sendPing :: Server -> IO (Maybe PingResponse)
sendPing server = fromThrift <$> send protocol server CommonClient.ping
